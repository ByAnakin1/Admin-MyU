...
async function fetchProducts() {
    try {
        const res = await fetch('http://localhost:3000/api/bucket_hat'); // Ruta para obtener los productos de Bucket Hat
...
async function editProduct(id) {
    try {
        const res = await fetch(`http://localhost:3000/api/bucket_hat/${id}`); // Ruta para obtener el producto específico
