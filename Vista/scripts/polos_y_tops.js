...
async function fetchProducts() {
    try {
        const res = await fetch('http://localhost:3000/api/polos_y_tops'); // Ruta correcta para polos y tops
...
async function editProduct(id) {
    try {
        const res = await fetch(`http://localhost:3000/api/polos_y_tops/${id}`); // Ruta correcta para polos y tops
